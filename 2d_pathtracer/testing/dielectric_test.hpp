...
/// <summary>
/// test sampling from Dielectric Material (renders on current bound framebuffer)
/// </summary>
/// <param name="scene"></param>
/// <param name="vao"></param>
/// <param name="passthroughProgram"></param>
static void test_dielectric(Scene& scene,gpupro::VertexArray& vao, gpupro::Program& passthroughProgram, int count)
{
	...
	auto scaling = di(r.direction,r.direction,isect.normal);
	throughput*=scaling;
	...
	for (int i = 0; i < count; ++i)
	{
		...
		glm::vec2 woLocal = di.sample_dir(wiLocal,isect.normal,p);
