...
/// <summary>
/// test sampling from diffuse Material (renders on current bound framebuffer)
/// </summary>
/// <param name="scene"></param>
/// <param name="vao"></param>
/// <param name="passthroughProgram"></param>
static void test_diffuse(Scene& scene,gpupro::VertexArray& vao, gpupro::Program& passthroughProgram, int count)
{
	...
	auto scaling = dif(r.direction,r.direction,isect.normal);
	throughput*=scaling;
	...
	for (int i = 0; i < count; ++i)
	{
		...
		glm::vec2 woLocal = dif.sample_dir(wiLocal,isect.normal,p);
