...
namespace gpupro
{
    ...
    public:
        ...
        struct Desc
        {
            ...
            // number of samples for multisampling (0 = disabled, valid values are 1,2,4,8,16) https://www.khronos.org/opengl/wiki/Multisampling
            int multisamples = 0;
            // number of bits for the depth buffer (usually 0, 16, 24 or 32)
            int depthBits = 32;
            // number if bits for the stencil buffer (0 or 8)
            int stencilBits = 0;
        };

        /// \brief creates a new window
        /// \param desc Description of the window setup (see above)
        ...
        /// \return true if the left button of the mouse is pressed
